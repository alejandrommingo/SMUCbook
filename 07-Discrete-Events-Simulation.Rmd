...
# Discrete Events Simulation: Replication
...
# Discrete Events Simulation: Plots
...
# Discrete Events Simulation: Plot of resources
...
# Discrete Events Simulation: Plot of arrivals
...
# Discrete Events Simulation: Plot of trayectories
...
# Discrete Events Simulation: Improving the system

Now that we know a bit about the `simmer` tool we are going to make some changes in the system to try to improve its efficiency.
